...
public class ModelBiped extends ModelBase
{
    ...
    protected float smoothSneakProgress;
    public ModelBiped()
    {
        this(0.0F);
    }
    ...
    public void setSneakProgress(float progress)
    {
        this.smoothSneakProgress = progress;
    }
    ...
    public void render(Entity entityIn, float p_78088_2_, float p_78088_3_, float p_78088_4_, float p_78088_5_, float p_78088_6_, float scale)
    {
        ...
        {
            GlStateManager.translate(0.0F, this.smoothSneakProgress * 0.2F, 0.0F);
    ...
    public void setRotationAngles(float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch, float scaleFactor, Entity entityIn)
    {
        ...
        float sneak = this.smoothSneakProgress;

        this.bipedBody.rotateAngleX = 0.5F * sneak;
        this.bipedRightArm.rotateAngleX += 0.4F * sneak;
        this.bipedLeftArm.rotateAngleX += 0.4F * sneak;

        this.bipedRightLeg.rotationPointZ = 0.1F + (4.0F - 0.1F) * sneak;
        this.bipedLeftLeg.rotationPointZ = 0.1F + (4.0F - 0.1F) * sneak;

        this.bipedRightLeg.rotationPointY = 12.0F + (9.0F - 12.0F) * sneak;
        this.bipedLeftLeg.rotationPointY = 12.0F + (9.0F - 12.0F) * sneak;

        this.bipedHead.rotationPointY = sneak;
    ...
    public void setModelAttributes(ModelBase model)
    {
        ...
        if (model instanceof ModelBiped)
        {
            ...
            this.smoothSneakProgress = modelbiped.smoothSneakProgress;
        }
    }
